<div id="cardMessage" class="top-[5%] left-[50%] translate-x-[-50%] flex items-center justify-center    absolute">
    <div
        ...
        <button type="button" id="flashMessageButton"
            class="ms-auto -mx-1.5 -my-1.5 bg-red-50  rounded-lg focus:ring-2 focus:ring-red-500 p-1.5 hover:bg-red-200 inline-flex items-center justify-center h-8 w-8 dark:bg-slate-950  dark:hover:bg-gray-700"
